    ...
    return(
       ...
       <div className="flex items-center justify-between py-5">
        <div className="flex flex-shrink-0 items-center">
            <Link href="/" className="text-[#16f2b3] text-3xl font-bold"  >Shrikant Surwase cool</Link>
        </div>
        <ul className="mt-4 flex h-screen max-h-0 w-full flex-col items-start text-sm opacity-0 md:mt-0 md:h-auto md:w-auto md:max-h-screen md:flex-row md:opacity-100 md:space-x-1 md:border-0 ">
        <li>
